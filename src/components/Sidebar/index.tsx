...
import VTFicon from '../../images/icon/icon-vtf.svg';
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-10 py-5.5 lg:py-6.5">
        <NavLink to="/">
          <img src="https://mitoworld.io/wp-content/uploads/2022/11/Logo_mix-1.png" alt="Logo" />
        </NavLink>
      ...
      <div className='absolute bottom-5 text-bodydark1 flex w-full justify-center'>
            V1.0 Powered by <img src={VTFicon} className='ml-3' />
          </div>
    </aside>
  );
};
